...
_G.packer_plugins = {
  ...
  ["FixCursorHold.nvim"] = {
    loaded = true,
    path = "/home/Jack/.local/share/nvim/site/pack/packer/start/FixCursorHold.nvim",
  ...
  ["alpha-nvim"] = {
    loaded = true,
    path = "/home/Jack/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/Jack/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["dashboard-nvim"] = {
    loaded = true,
    path = "/home/Jack/.local/share/nvim/site/pack/packer/start/dashboard-nvim",
  ...
  ["nvim-lightbulb"] = {
    loaded = true,
    path = "/home/Jack/.local/share/nvim/site/pack/packer/start/nvim-lightbulb",
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/Jack/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
  ...
  ["onedarkpro.nvim"] = {
    loaded = true,
    path = "/home/Jack/.local/share/nvim/site/pack/packer/start/onedarkpro.nvim",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/home/Jack/.local/share/nvim/site/pack/packer/start/vim-bbye",
